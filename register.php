...
if(isset($_POST["register"])){
 if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if( !empty($username) and !empty($email) and !empty($phone_number) and !empty($password) ){
      ...
      <form  action="register.php" method="POST">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" name="email" placeholder="Enter your email" class="email" required>
          </div>
          <div class="input-box">
            <span class="details">Phone Number</span>
            <input type="text" name="phone_number" placeholder="Enter your number" class="phone_number" required>
          </div>
          <div class="input-box">
